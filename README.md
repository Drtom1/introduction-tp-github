...
1. Under **Assignees** on the right side of the screen, add yourself.
   ...
   Because you created the pull request, you can't assign yourself as a reviewer, but feel free to assign a friend as a reviewer instead to see how it works :smile: Great till this point
